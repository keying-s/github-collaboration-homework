...
| 上手引导与可重看指南：分章剧情简报（中/英切换）、顶栏指南按钮、安全训练场（开火/切换/闪避/拾取要点）、第 1 关情境提示 | fredericsetievi | [#PRNUM](https://github.com/keying-s/github-collaboration-homework/pull/PRNUM) · [#32](https://github.com/keying-s/github-collaboration-homework/issues/32) | 待评审 |
