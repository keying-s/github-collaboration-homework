...
export const TRANSLATIONS = {
  'zh-CN': {
    ...
    currentLoadout: '当前装备',
    upgradeAxes: '火力强化',
    upgradeNote: '清房暂停三选一，所选属性 ×2；极端流或均衡流都凶。',
    awaitBoost: '清空房间获得强化',
    fullState: '每关满状态出发',
    ...
    upgradeTitle2: '更凶一点。',
    upgradeDescription: '三选一，所选属性 ×2，本次行动持续叠加。',
    takeUpgrade: '取用',
    ...
    practiceTitle: '训练场',
    practiceIntro: '安全沙盒：你不会受到伤害。试着开火、闪避、换弹。完成要点即可离开。',
  ...
  en: {
    ...
    upgradeNote:
      'Clear a room, pick one of three: the chosen stat doubles. Go extreme or stay even.',
    awaitBoost: 'Clear rooms to earn boosts',
    ...
    upgradeDescription: 'Pick one of three: the chosen stat doubles for the whole run.',
    takeUpgrade: 'TAKE',
    ...
    clearPortal: 'AREA CLEAR · HEAD TO THE RIGHT GATE',
    ...
    practiceIntro:
      'A safe sandbox: you take no damage. Try firing, dashing, and reloading. Finish the drills to leave.',
