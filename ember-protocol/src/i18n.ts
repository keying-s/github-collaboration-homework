...
export const TRANSLATIONS = {
  'zh-CN': {
    ...
    currentLoadout: '当前装备',
    upgradeAxes: '火力强化',
    upgradeNote: '清房暂停二选一，所选属性 ×2；极端流或均衡流都凶。',
    awaitBoost: '清空房间获得强化',
    fullState: '每关满状态出发',
    ...
    upgradeTitle2: '更凶一点。',
    upgradeDescription: '二选一，所选属性 ×2，本次行动持续叠加。',
    takeUpgrade: '取用',
  ...
  en: {
    ...
    upgradeNote: 'Clear a room, pick a boost: the chosen stat doubles. Go extreme or stay even.',
    ...
    upgradeDescription: 'Pick one: the chosen stat doubles for the whole run.',
    takeUpgrade: 'TAKE',
