...
export const TRANSLATIONS = {
  'zh-CN': {
    ...
    levelObjective3: '穿越排气区',
    levelObjective4: '击败孢核守卫',
    clearedCount: '已清除',
    bestCombo: '最高连击',
    operationMode: '行动模式',
    solo: '单人',
    ...
    storyCh3Title: '你的任务',
    storyCh3: '深入 4 个隔离区，清除感染群，击败孢核守卫，在感染扩散前终止它。',
    storyCh4Title: '没有退路',
    ...
    ctrlReload: 'R 换弹',
    ctrlInteract: 'E 拾取武器 / 技能，或进入传送门',
    ctrlSwitch: 'Q 切换已拥有的枪械',
    ctrlPause: 'Esc 暂停 / 随时查看指南',
    practiceTitle: '训练场',
    practiceIntro:
      '安全沙盒：你不会受到伤害。试着开火、切换枪械、闪避，靠近武器按 E 拾取。完成要点即可离开。',
    trainShoot: '开火：按住鼠标左键',
    trainSwitch: '切换枪械：按 Q',
    trainDash: '闪避：按 Space',
    trainPickup: '拾取：靠近武器按 E',
  ...
  en: {
    ...
    levelObjective3: 'Cross the exhaust gauntlet',
    levelObjective4: 'Defeat the Spore Warden',
    ...
    storyCh3:
      'Push through 4 sectors, clear the infected, defeat the Spore Warden, and end it before it spreads.',
    ...
    ctrlSwitch: 'Q to switch owned weapons',
    ctrlPause: 'Esc to pause / open the guide anytime',
    practiceTitle: 'TRAINING RANGE',
    practiceIntro:
      'A safe sandbox: you take no damage. Try firing, switching weapons, dashing, and pressing E near a weapon. Finish the drills to leave.',
    trainShoot: 'FIRE: hold left mouse',
    trainSwitch: 'SWITCH: press Q',
    trainDash: 'DASH: press Space',
    trainPickup: 'PICK UP: press E near a weapon',
