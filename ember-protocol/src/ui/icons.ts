...
export function gunIcon(id: string) {
  return `<svg viewBox="0 0 150 55" fill="none" aria-hidden="true"><path d="M15 20h75v17H59l-5 13H43l3-13H24l-9-5H5v-9h10z" fill="${id === 'flamer' ? '#e08a5c' : '#b8c6b7'}"/><path d="M89 23h49v9H89zM33 14h37v5H33zM70 34l12 15H69L59 34z" fill="#617771"/><path d="M22 23h23v5H22zM58 23h5v10h-5zM68 23h5v10h-5zM78 23h5v10h-5z" fill="#293f3c"/>${id === 'flamer' ? '<path d="M96 18h14v20H96z" fill="#7a4a38"/><path d="M110 21h24v13H110z" fill="#c96b3f"/><circle cx="140" cy="27" r="6" fill="#ffd9a8"/><path d="M146 27h4" stroke="#ffb066" stroke-width="3"/>' : ''}</svg>`;
}
